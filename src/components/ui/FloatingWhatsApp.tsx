  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3 md:bottom-8 md:right-8">
      ...
      >
        ...
        <span className="relative z-10 hidden pr-1 text-sm font-semibold group-hover:inline">
          Facebook
        </span>
      </motion.a>
      ...
      <motion.a
        ...
        className="group relative flex items-center gap-2 rounded-full bg-[#25D366] p-3.5 text-white shadow-[0_10px_30px_-10px_rgba(37,211,102,0.8)] ring-1 ring-black/5 transition-transform hover:-translate-y-0.5 hover:shadow-[0_14px_36px_-10px_rgba(37,211,102,0.9)] focus:outline-none focus-visible:ring-2 focus-visible:ring-white"
      >
        <span
          aria-hidden
